...
export let hospitalData: Object[] = [
    {
        ...
        Id: 1014,
        Name: 'Adams',
        StartTime: new Date(2018, 6, 5, 16, 0),
        EndTime: new Date(2018, 6, 5, 17, 0),
        ...
        DepartmentName: 'DIABETOLOGY',
        DepartmentId: 5,
        StartTime: new Date(2018, 6, 6, 12, 0),
        EndTime: new Date(2018, 6, 6, 13, 0),
        DoctorId: 6,
        PatientId: 2,
        Symptoms: 'Urinating often, Extreme fatigue, Blurry vision'
    }, {
        ...
        DepartmentName: 'DIABETOLOGY',
        DepartmentId: 5,
        StartTime: new Date(2018, 6, 6, 18, 0),
        EndTime: new Date(2018, 6, 6, 18, 30),
        DoctorId: 6,
        PatientId: 3,
        ...
        DepartmentName: 'DIABETOLOGY',
        DepartmentId: 5,
        StartTime: new Date(2018, 6, 4, 14, 0),
        ...
        EndTime: new Date(2018, 6, 4, 13, 0),
        DoctorId: 6,
        PatientId: 1,
        ...
        EndTime: new Date(2018, 6, 2, 13, 0),
        DoctorId: 6,
        PatientId: 2,
        Symptoms: 'Urinating often, Extreme fatigue, Blurry vision'
    }, {
        Id: 1021,
        Name: 'Adams',
        StartTime: new Date(2018, 6, 6, 10, 0),
        EndTime: new Date(2018, 6, 6, 11, 0),
        Disease: 'Bone Fracture',
        DepartmentName: 'ORTHOPEDICS',
        DepartmentId: 4,
        DoctorId: 5,
        ...
        Id: 1022,
        Name: 'Mercy',
        StartTime: new Date(2018, 6, 2, 15, 0),
        EndTime: new Date(2018, 6, 2, 15, 30),
        Disease: 'Left Arm Fracture',
        DepartmentName: 'ORTHOPEDICS',
        DepartmentId: 4,
        DoctorId: 5,
        ...
        DepartmentName: 'CARDIOLOGY',
        DepartmentId: 6,
        StartTime: new Date(2018, 6, 6, 14, 0),
        EndTime: new Date(2018, 6, 6, 14, 30),
        DoctorId: 7,
        PatientId: 2,
        ...
        DepartmentName: 'CARDIOLOGY',
        DepartmentId: 6,
        StartTime: new Date(2018, 6, 4, 17, 30),
        EndTime: new Date(2018, 6, 4, 18, 30),
        DoctorId: 7,
        PatientId: 3,
        ...
        DepartmentName: 'CARDIOLOGY',
        DepartmentId: 6,
        StartTime: new Date(2018, 6, 4, 15, 0),
        EndTime: new Date(2018, 6, 4, 15, 30),
        DoctorId: 7,
        PatientId: 4,
        ...
        DepartmentName: 'CARDIOLOGY',
        DepartmentId: 6,
        StartTime: new Date(2018, 6, 3, 17, 0),
        EndTime: new Date(2018, 6, 3, 18, 30),
        DoctorId: 7,
        PatientId: 2,
        ...
        DepartmentName: 'CARDIOLOGY',
        DepartmentId: 6,
        StartTime: new Date(2018, 6, 6, 15, 30),
        EndTime: new Date(2018, 6, 6, 16, 0),
        DoctorId: 7,
        PatientId: 2,
        Symptoms: 'A fluttering in your chest'
    }, {
...
export let activityData: Object[] = [
    ...
    },
    {
        ...
        Message: 'Laura for General Checkup on 7th July, 2018 @ 8.30 AM with Dr.Molli Cobb',
        Time: '5 mins ago',
        Type: 'appointment',
    ...
    {
        Name: 'Added New Appointment',
        Message: 'Joseph for consultation on 7th Feb, 2019 @ 11.10AM with Dr.Molli Cobb',
        Time: '5 mins ago',
        Type: 'appointment',
        ActivityTime: new Date(2018, 6, 1, 11, 0)
    }
...
export let startHours: Object[] = [
    { Value: '08:00', Text: '8h.00 ' },
    { Value: '09:00', Text: '9h.00 ' },
    { Value: '10:00', Text: '10h.00' },
    { Value: '11:00', Text: '11h.00' },
    { Value: '12:00', Text: '12h.00' }
];

export let endHours: Object[] = [
    { Value: '16:00', Text: '16h.00 ' },
    { Value: '17:00', Text: '17h.00 ' },
    { Value: '18:00', Text: '18h.00 ' },
    { Value: '19:00', Text: '19h.00 ' },
    { Value: '20:00', Text: '20h.00 ' },
    { Value: '21:00', Text: '21h.00 ' }
];
/*export let startHours: Object[] = [
