...
@Component({
  selector: 'app-medecine-board',
  templateUrl: './medecine-board.component.html',
  styleUrls: ['./medecine-board.component.scss']
})
export class MedecineBoardComponent implements AfterViewInit {
  @ViewChild('sideBar')
